...
const stripe = require('stripe')('sk_test_xsrKKBxsA6kF3kkDWuBGP7lI');
...
router.get('/checkout/single_package/:id', async (req, res, next) => {
...
router.get('/checkout/process_cart', async (req, res, next) => {
...
//CHAT PAGE
router.get('/users/:userId/orders/:orderId', async (req, res, next) => {
...
router.get('/users/:id/manage_orders', async (req, res, next) => {
